...
class SlotMachineImpl(override val player: Player) : SlotMachine {

    override var slots: Array<MutableList<Slot>>
        get() = Array<MutableList<Slot>>(3) {
            mutableListOf(
    ...
    override fun takeBet(betAmount: Int):ResponseWinner {
        ...
        val newAmount:Int=if(firstSlot.type==secondSlot.type && firstSlot.type==thirdSlot.type && secondSlot.type==thirdSlot.type){
            when(firstSlot.type){
